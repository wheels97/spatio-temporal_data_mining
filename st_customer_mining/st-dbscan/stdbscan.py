...
class STDBSCAN(object):
    ...
    def __init__(self, col_lat, col_lon, col_time, spatial_threshold=1000.0, 
                 temporal_threshold=60.0, min_neighbors=5):
        """
    ...
    def projection(self, df, p1_str='epsg:4326', p2_str='epsg:32635'):
        """
